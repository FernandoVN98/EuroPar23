...
def main(args):
    ...
    x_test = ds.array(x_test, (x_test.shape[0], 28))
    y_test = ds.array(y_test, (y_test.shape[0], 1))
    rf = RandomForestClassifier(n_estimators=48, try_features=4, distr_depth=4, n_classes=2, random_state=0)
    compss_barrier()
