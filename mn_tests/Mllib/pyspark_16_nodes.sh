...
#SBATCH --chdir=.
#SBATCH --output=$(pwd)/pyspark-HIGGS_16_nodes-%j.out
#SBATCH --error=$(pwd)/pyspark-HIGGS_16_nodes-%j.err
#SBATCH --qos=debug
...
/apps/SPARK/spark-3.1.2-bin-hadoop3.2/bin/spark-submit --master spark://$master_ip:7077 --executor-cores 4 --executor-memory 25G --driver-memory 12G  pyspark_HIGGS_16_nodes.py $1
